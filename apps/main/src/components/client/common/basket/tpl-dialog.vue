<template >
    ...
    <div class="com" >
        ...
        <div class="c-handler"
             v-if="showBasketHandler && items.length > 0 && $store.getters['client_basket/priceDisplay'] > min_summ " >

            <v-btn block color="#EE3124" dark rounded @click="dialog=true" >

                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"
                     class="mr-3" >
                    <path d="M20.87 8.5293C20.4102 7.95352 19.7829 7.63555 19.104 7.63555H17.5528C17.4067 3.65664 14.5235 0.472656 11.0001 0.472656C7.47663 0.472656 4.59343 3.65664 4.44733 7.63555H2.89616C2.21726 7.63555 1.58991 7.95352 1.13015 8.5293C0.550069 9.25117 0.339522 10.2566 0.558662 11.2234L2.41921 19.4219C2.69851 20.6594 3.66101 21.5273 4.75671 21.5273H17.2391C18.3348 21.5273 19.2973 20.6637 19.5766 19.4219L21.4415 11.2234C21.6606 10.2566 21.4501 9.25117 20.87 8.5293ZM11.0001 2.22578C13.561 2.22578 15.6579 4.62344 15.7954 7.63555H6.20476C6.34226 4.62773 8.43913 2.22578 11.0001 2.22578ZM19.7313 10.8324L17.8708 19.0352C17.7762 19.4562 17.5055 19.7742 17.2434 19.7742H4.75671C4.4946 19.7742 4.2239 19.4562 4.12937 19.0352L2.26882 10.8324C2.16999 10.3984 2.10983 9.38867 2.89616 9.38867H19.104C19.9505 9.38867 19.8301 10.3984 19.7313 10.8324Z"
                          fill="white" />
                    <path d="M6.64731 11.1333C6.16177 11.1333 5.77075 11.5243 5.77075 12.0099V17.4884C5.77075 17.9739 6.16177 18.3649 6.64731 18.3649C7.13286 18.3649 7.52388 17.9739 7.52388 17.4884V12.0099C7.52817 11.5286 7.13286 11.1333 6.64731 11.1333Z"
                          fill="white" />
                    <path d="M10.897 11.1333C10.4114 11.1333 10.0204 11.5243 10.0204 12.0099V17.4884C10.0204 17.9739 10.4114 18.3649 10.897 18.3649C11.3825 18.3649 11.7735 17.9739 11.7735 17.4884V12.0099C11.7735 11.5286 11.3782 11.1333 10.897 11.1333Z"
                          fill="white" />
                    <path d="M15.1423 11.1333C14.6568 11.1333 14.2657 11.5243 14.2657 12.0099V17.4884C14.2657 17.9739 14.6568 18.3649 15.1423 18.3649C15.6279 18.3649 16.0189 17.9739 16.0189 17.4884V12.0099C16.0189 11.5286 15.6279 11.1333 15.1423 11.1333Z"
                          fill="white" />
                </svg >
        ...
        <div class="c-handler"
             v-else-if="showBasketHandler && items.length > 0 && $store.getters['client_basket/priceDisplay'] < min_summ" >

            <v-btn block color="#BDBDBD" dark rounded @click="dialog=true" >
                ...
                <v-row class="flex-column px-2">
                    <div class="main_summ" >
                        {{$store.getters['client_basket/priceDisplay']}} &#8381;
                    </div >
                    <div class="ostatok" >
                         ещё {{ min_summ - $store.getters['client_basket/priceDisplay'] }}
                    </div >
                </v-row >
