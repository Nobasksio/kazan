<template >
    <v-container class="pt-1">
        <v-row class="justify-space-between">
            <v-col>
                <svg class='mt-3 ml-4' width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <v-col>
                <v-btn rounded class="red darken-1 white--text my-bold overflow-hidden max text-right" @click="setshow3" >
                    Иркутск -> Казань
                </v-btn >
            </v-col>
